    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://localhost/smarteditor/php_uploader/file_uploader_html5.php'; 	//upload URL
		//sUploadURL= 'http://localhost:9090/static/smarteditor2/sample/photo_uploader/file_uploader_html5.php'; 	//upload URL
    	//파일을 하나씩 보내고, 결과를 받음.
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
			sUrl  : 'http://localhost/smarteditor/php_uploader/file_uploader.php',	//샘플 URL입니다.
			sCallback : '/static/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
